...
public class AltaAlumno extends javax.swing.JFrame {
  ...
  Vector cabeceras= new Vector();
    ...
    public AltaAlumno() {
        ...
        cabeceras.addElement("Apedillo Materno");
        cabeceras.addElement("Matricula");
        cabeceras.addElement("Semestre");
        modTabla = new DefaultTableModel(cabeceras,0);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String ApePater = jTextField3.getText();
        String ApeMater = jTextField2.getText();
        String Codigo = jTextField5.getText();
        String Semestre = jTextField4.getText();
        
        alumno.setNombre(nombre);
        alumno.setApePater(ApePater);
        alumno.setApeMater(ApeMater);
        alumno.setCodigo(Codigo);
        alumno.setSemestre(Semestre);
        
        metodos.guardar(alumno);
        metodos.guardarAlumno(alumno);
