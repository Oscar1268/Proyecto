...
public class BajasMaestro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("selecciona a un maestro para dar de baja");

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setText("Bajas Maestro");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        modTablam.removeRow(jTable1.getSelectedRow());
        try{
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BajasMaestro().setVisible(true);
            }
        });
    }
